...
@Component({
  selector: 'app-price-invoice-details-form-dialog',
  templateUrl: './price-invoice-details-form-dialog.component.html',
  styleUrls: ['./price-invoice-details-form-dialog.component.scss']
})
export class PriceInvoiceDetailsFormDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PriceInvoiceDetailsFormDialogComponent>,
    ...
    this.priceInvoiceId = this.data.priceInvoiceId;

    this.newInvItemForm.patchValue({
      orderId: Number(this.priceInvoiceId)
    });
  }
