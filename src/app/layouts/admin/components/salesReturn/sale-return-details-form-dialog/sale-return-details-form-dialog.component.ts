...
import { SalesReturnOrderDetailsItemForm } from '../../../form-controls/salesReturnOrderDetailsItem-form';
import { SalesReturnOrderDetailsService } from 'src/app/service/salesReturnOrderDetails.service';


@Component({
  selector: 'app-sale-return-details-form-dialog',
  templateUrl: './sale-return-details-form-dialog.component.html',
  styleUrls: ['./sale-return-details-form-dialog.component.scss']
})
export class SaleReturnDetailsFormDialogComponent implements OnInit {
  ...
  constructor(
    private salesReturnOrderDetailsItemForm: SalesReturnOrderDetailsItemForm,
    private invItemService: InvItemService,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<SaleReturnDetailsFormDialogComponent>,
    ...
    if (this.data.formMode === FormMode.CREATE) {
      this.newInvItemForm = this.salesReturnOrderDetailsItemForm.createForm();

    } else {
      this.newInvItemForm = this.salesReturnOrderDetailsItemForm.setForm(this.data.orderItem);
  ...
  onSubmit() {
    ...
    this.salesReturnOrderDetailsService
